...
| [`pleasync` (CLI)](./packages/cli) | [![npm](https://img.shields.io/npm/v/pleasync.svg)](https://www.npmjs.com/package/pleasync) | `generate` / `plan` / `apply` / `introspect` |
...
npm install -D pleasync@beta @pleasync/schema@beta
